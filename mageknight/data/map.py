...
class Tile:
    ...
    _sites = {
          ...
          '5':  [0, Site.monastery, Site.maraudingOrcs, (Site.crystalMines, Mana.blue), 0, Site.magicalGlade, 0],
          '6':  [(Site.crystalMines, Mana.red), 0, 0, Site.maraudingOrcs, 0, Site.monsterDen, 0],
          ...
          'c2': [0, Site.ancientRuins, (Site.crystalMines, Mana.green), Site.draconum, Site.mageTower, 0, 0],
          'c3': [0, Site.ancientRuins, Site.mageTower, 0, (Site.crystalMines, Mana.white), Site.tomb, 0],
          'c4': [Site.draconum, 0, Site.keep, 0, Site.ancientRuins, 0, (Site.crystalMines, Mana.blue)],
          ...
          'c8': [Site.city, (Site.crystalMines, Mana.red), 0, Site.draconum, 0, Site.draconum, Site.ancientRuins],
    }
    ...
    def allSites(self):
        ...
        sites = []
        for coords in [hexcoords.HexCoords(0, 0)] + hexcoords.HexCoords(0, 0).neighbors():
